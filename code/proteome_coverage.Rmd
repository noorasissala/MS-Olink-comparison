...
n_ms <- length(setdiff(ms_proteins_filtered, olink_proteins_filtered))
n_olink <- length(setdiff(olink_proteins_filtered, ms_proteins_filtered))
...
n_ms <- length(setdiff(ms_proteins_filtered, union(olink_proteins_filtered, plasma_proteome)))
n_olink <- length(setdiff(olink_proteins_filtered, union(ms_proteins_filtered, plasma_proteome)))
n_plasma <- length(setdiff(plasma_proteome, union(ms_proteins_filtered, olink_proteins_filtered)))

overlap_all <- intersect(intersect(ms_proteins_filtered, olink_proteins_filtered), plasma_proteome)
n_overlap_all <- length(overlap_all)

n_ms_olink <- length(setdiff(overlap_filtered, overlap_all))
n_ms_plasma <- length(setdiff(intersect(ms_proteins_filtered, plasma_proteome), overlap_all))
n_olink_plasma <- length(setdiff(intersect(olink_proteins_filtered, plasma_proteome), overlap_all))
...
ms_unique_max50NA <- setdiff(ms_proteins_filtered, olink_proteins_filtered)
olink_unique_max50NA <- setdiff(olink_proteins_filtered, ms_proteins_filtered)
